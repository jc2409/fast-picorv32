...
THIS FILE CONTAINS MANY VERSIONS/ITERATIONS OF THE ICACHE WITH DIFFERENT STRENGTHS
This will eventually be cleaned down to the final version used near project completion.
...
- *** Multiword Cache with Lookahead (Zero-cycle hits) ***
   ...
   la_cached_* registers store retrieved tag/data/valid during lookahead cycle
...
/***************************************************************************************************************
    ...
    which is the same size as 128x16 direct-mapped
*/
